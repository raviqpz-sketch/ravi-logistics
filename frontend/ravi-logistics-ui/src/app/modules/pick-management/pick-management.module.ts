...
import { ConfirmPickDialogComponent } from './components/confirm-pick-dialog.component';

const routes: Routes = [{ path: '', component: PickListComponent }];

@NgModule({
  declarations: [PickListComponent, ConfirmPickDialogComponent],
  imports: [
    ...
    MatTooltipModule, MatPaginatorModule, MatChipsModule
  ]
})
export class PickManagementModule {}
