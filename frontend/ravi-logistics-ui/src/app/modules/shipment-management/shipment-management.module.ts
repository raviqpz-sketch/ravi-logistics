...
const routes: Routes = [{ path: '', component: ShipmentListComponent }];

@NgModule({
  declarations: [ShipmentListComponent, CreateShipmentDialogComponent],
  imports: [
    ...
    MatPaginatorModule, MatDatepickerModule, MatNativeDateModule, MatChipsModule
  ]
})
